namespace ContasPagar
{
  partial class frmCadastroHistorico
  {
   ...
   this.cbx_Debcre = new System.Windows.Forms.ComboBox();
   this.SuspendLayout();
   // 
   // lbl_descricao
   // 
   ...
   this.lbl_debcre.Location = new System.Drawing.Point(26, 57);
   ...
   // cbx_Debcre
   // 
   this.cbx_Debcre.FormattingEnabled = true;
   this.cbx_Debcre.Items.AddRange(new object[] {
            "C",
            "D"});
   this.cbx_Debcre.Location = new System.Drawing.Point(88, 49);
   this.cbx_Debcre.Name = "cbx_Debcre";
   this.cbx_Debcre.Size = new System.Drawing.Size(50, 21);
   this.cbx_Debcre.TabIndex = 7;
   this.cbx_Debcre.SelectedIndexChanged += new System.EventHandler(this.cb_debcre_SelectedIndexChanged);
   // 
   ...
   this.Controls.Add(this.cbx_Debcre);
   ...
   this.PerformLayout();
    ...
    private System.Windows.Forms.ComboBox cbx_Debcre;
  }
}